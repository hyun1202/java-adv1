...
//        BoundedQueue queue = new BoundedQueueV6_1(2); // 버퍼 크기
//        BoundedQueue queue = new BoundedQueueV6_2(2); // 버퍼 크기
//        BoundedQueue queue = new BoundedQueueV6_3(2); // 버퍼 크기
        BoundedQueue queue = new BoundedQueueV6_4(2); // 버퍼 크기
